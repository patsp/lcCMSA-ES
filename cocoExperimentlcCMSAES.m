%
% This script runs the lcCMSA-ES variants for BUDGET_MULTIPLIER*DIM
...
observer_options = strcat('result_folder: ', name, '_on_', ...
    ...
    [' algorithm_name: ', name,...
       ' algorithm_info: ', name, '_with_blackbox_conversion_to_interior '], ...
...
while true
    ...
    while (BUDGET_MULTIPLIER*dimension > (cocoProblemGetEvaluations(problem) + ...
        ...
        runlcCMSAESOnCocoProblem(problem, ...
